...
if (length(args) == 0) {
  ...
  n.sample <- 50 #Number of individuals to be selected from the full sample; if full sample, enter "ALL"
...
NHANES<- fread("01_Inputs/NHANES_1318_Imp_dm_fi.csv", stringsAsFactors = TRUE, data.table = FALSE)
